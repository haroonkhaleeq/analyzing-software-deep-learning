...
class Code_Completion_Final:
    ...
    def prepare_data(self, token_lists):
        ...
        for token_list in token_lists:
            for idx, token in enumerate(token_list):
                ...
                xs.append([previous_4_token_string, previous_3_token_string, previous_2_token_string,
    ...
    def create_network(self):
        ...
        self.model_1 = tflearn.DNN(self.net)

    def load(self, token_lists, model_file):
        self.prepare_data(token_lists)
        self.create_network()
        self.model_1.load(model_file)

    def train(self, token_lists, model_file):
        (xs, ys) = self.prepare_data(token_lists)
        self.create_network()
        self.model_1.fit(xs, ys, n_epoch=1, batch_size=600, show_metric=True)
        self.model_1.save(model_file)
    ...
    def query(self, prefix, suffix):
        ...
        predicted = []
        x = [previous_4_token_string, previous_3_token_string, previous_2_token_string, previous_1_token_string]
